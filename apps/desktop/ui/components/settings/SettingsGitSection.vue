  ...
  <div class="space-y-6">
    ...
    <div class="space-y-4">
      ...
      <SettingsField
        ...
        hint="Add a Co-Authored-By: AWOG trailer to commits AWOG creates — session commits and task auto-commits"
      >
        <AppToggle
          :model-value="git.commitCoAuthor"
          @update:model-value="update({ commitCoAuthor: $event })"
        />
      </SettingsField>
