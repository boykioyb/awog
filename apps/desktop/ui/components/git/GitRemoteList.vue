<template>
  <div class="flex flex-col h-full overflow-hidden">
    ...
    >
      <div class="text-[1em] uppercase tracking-wider" :style="{ color: t.textDim }">Remotes</div>
    </div>
    <div class="flex-1 overflow-y-auto">
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <span class="text-[1em] font-medium" :style="{ color: t.text }">{{ r.name }}</span>
        </div>
        <div class="mt-2 grid gap-1 text-[1em]" style="grid-template-columns: 60px 1fr">
