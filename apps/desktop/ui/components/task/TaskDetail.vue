  ...
  <div class="flex-1 overflow-y-auto">
    <div class="px-4 md:px-6 py-4 md:py-5" :style="{ borderBottom: `1px solid ${t.border}` }">
      <div class="flex items-center gap-2 mb-3">
        <span class="text-[11px] font-mono" :style="{ color: t.textDim }">{{ task.id }}</span>
        <span :style="{ color: t.textFaint }">·</span>
        <span class="text-[11px]" :style="{ color: t.textDim }">{{ task.createdAt }}</span>
        <div
          class="ml-auto inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[11px]"
      ...
      <div class="flex items-center gap-3 text-[12px] flex-wrap" :style="{ color: t.textMuted }">
      ...
      <div class="mt-3 text-[13px] leading-relaxed" :style="{ color: t.textMuted }">
        {{ task.description }}
      </div>
    </div>
    <div class="px-4 md:px-6 py-4">
      <div
        class="text-[11px] uppercase tracking-wider font-medium mb-3"
