  ...
  >
    <div class="vpe">
      ...
      <div class="vpe-secret">
        ...
        <div class="vpe-field">
          <label class="vpe-sub-label">
            {{ t('vpn.editor.creds.username') }}
            <span v-if="profile?.hasUserPass" class="vpe-set">
              {{ t('vpn.editor.creds.setUserPass') }}
            </span>
          </label>
          <input
            v-model="username"
        ...
        <div class="vpe-field">
          <label class="vpe-sub-label">
            {{ t('vpn.editor.creds.keyPassphrase') }}
            <span v-if="profile?.hasKeyPassphrase" class="vpe-set">
              {{ t('vpn.editor.creds.setPassphrase') }}
            </span>
          </label>
          <div class="vpe-pw">
            <input
        ...
        <div class="vpe-hint">
          {{ isExisting ? t('vpn.editor.creds.keepHint') : t('vpn.editor.creds.hint') }}
        </div>
      </div>
    </div>
...
// credential fields are WRITE-ONLY: blank on open, omitted when blank, and emitted
// separately from the config so the page can persist them to the keychain via
// vpn.setCredential. The id is auto-generated by the store on create (never shown).
