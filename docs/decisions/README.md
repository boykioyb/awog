...
| [0074](./0074-session-message-anchor-and-transcript-navigation.md) | Neo tin nhắn bền (`eid` cho mọi role) + hợp đồng mở render-window rồi scroll; lớp data-find tách khỏi DOM-highlight | Accepted (T0a amended by 0075) |
